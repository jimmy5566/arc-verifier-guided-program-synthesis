...
\author{Yuzhe Ma\\\small University of Adelaide\\\small \texttt{a1918429@adelaide.edu.au}\\\small \url{https://github.com/jimmy5566}}
...
\paragraph{Research questions.} \textbf{RQ1:} How should representation capacity, neural candidate generation, and candidate selection be separated and measured? \textbf{RQ2:} Can provenance-aware, target-blind grid-level selection improve use of generated candidates without leaking target information? \textbf{RQ3:} How can inference be scaled operationally without changing the solver's semantics?
