...
def build(*, output: Path, owner: str, dataset_slug: str, kernel_slug: str, source_commit: str) -> dict[str, Any]:
    ...
    _write(kernel / "kernel-metadata.json", {"id": f"{owner}/{kernel_slug}", "title": "ARC2 Smoke30 reference-like representation alignment", "code_file": notebook_name, "language": "python", "kernel_type": "notebook", "is_private": True, "enable_gpu": True, "enable_tpu": False, "enable_internet": False, "dataset_sources": [f"{owner}/{dataset_slug}"], "kernel_sources": ["sorokin/pip-install-unsloth-flash-patch"], "competition_sources": ["arc-prize-2026-arc-agi-2"], "model_sources": ["sorokin/qwen3_4b_grids15_sft139/Transformers/bfloat16/1"], "docker_image": "gcr.io/kaggle-private-byod/python@sha256:320043e14c68293f1c946585b9257123385205a58af4b94b17d31868cae4e868", "machine_shape": "NvidiaL4"})
