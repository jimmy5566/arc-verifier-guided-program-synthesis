...
def main() -> None:
    ...
    turbo={key:sum(int(x["turbodfs"].get(key,0)) for x in record_values) for key in ("expanded_branches","probability_pruned","complete_candidates","generated_tokens","invalid_view_count")}
