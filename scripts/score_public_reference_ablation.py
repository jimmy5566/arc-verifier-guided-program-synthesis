...
FROZEN_STATUSES = {
    ...
    "PARTIAL_COHORT_A_FROZEN_BEFORE_EXACT_SCORING",
    "PARTIAL_COHORT_B_FROZEN_BEFORE_EXACT_SCORING",
    "PARTIAL_COHORT_C_FROZEN_BEFORE_EXACT_SCORING",
    "PARTIAL_COHORT_D_FROZEN_BEFORE_EXACT_SCORING",
}
