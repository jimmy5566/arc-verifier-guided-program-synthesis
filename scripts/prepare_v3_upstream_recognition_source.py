"""Build a minimal private Kaggle attachment for Track-U inference only."""
...
def main() -> None:
    ...
    forbidden_terms = ("oracle", "solution", "backend_audit", "parameter", "rule_spec", "executor", "verifier", "macro_compiler")
    ...
    metadata = {"title": "ARC2 V3 Upstream Recognition Source", "subtitle": "Offline train-only RuleSkeleton inference", "description": "Track U only; no oracle, solutions, backend, parameters, RuleSpec, executor, or verifier.", "id": f"{args.owner}/{args.dataset_slug}", "licenses": [{"name": "other"}]}
