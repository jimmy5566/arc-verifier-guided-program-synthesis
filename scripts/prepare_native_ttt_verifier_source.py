...
_FILES = (
    ...
    "configs/ARC2_NATIVE_LIKELIHOOD_RANKER_V2_FAST.json", "scripts/run_qwen4b_native_augmentation_search.py", "scripts/run_native_ttt_memory_smoke.py", "scripts/rerank_native_multiview_likelihood.py", "scripts/run_dual_reasoning_smoke.py", "src/arc", "src/inference/__init__.py", "src/inference/arc_native_io.py", "src/inference/nvarc_native.py", "src/inference/nvarc_native_augmentation.py", "src/inference/nvarc_native_candidates.py", "src/inference/native_ranker.py", "src/inference/native_multiview_likelihood.py", "src/inference/dual_reasoning_smoke.py", "src/inference/nvarc_native_ttt.py", "src/inference/kaggle_l4_parallel_runner.py", "src/inference/qwen3_transformers_parallel_runner.py",
)
